...
export default function Draft() {
  return (
    <div className={style.wrapper}>
      ...
      <p className={style.text}>
        As ferramentas de LLM (Large Language Model) utilizadas pela CocrIA são
        treinadas constantemente sobre os termos mais prováveis empregados em
        cada tipo de projeto e, a partir disto, produzem um texto-base próprio
        ao qual você poderá acrescentar as suas próprias palavras.
      </p>
    </div>
  );
}
